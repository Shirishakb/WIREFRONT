...
const Footer = () => {
    return (
        <footer id="footer" className="footer footer-expand-lg footer-dark bg-dark">
            <Link className="footerLink" to="https://github.com/Shirishakb">
            ...
            <Link className="footerLink" to="https://github.com/dylprograms">
